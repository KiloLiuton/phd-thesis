\chapter{Stochastic discrete phase model}
\label{chap:article}
...
\begin{figure}[!b]
\begin{center}
    \fbox{\includegraphics[width=0.35\textwidth]{fig/chap2/taxas.eps}}
...
\begin{figure}[b]
\begin{center}
    \fbox{\includegraphics[width=0.40\textwidth]{fig/chap2/ring.eps}}
